...
Namespace PrintToPACSDemo
   ...
   ''' </summary>
   Public Class SupportedCaps : Inherits System.Windows.Forms.Form
	  Private _gbCaps As System.Windows.Forms.GroupBox
	  Private _lblCaps As System.Windows.Forms.Label
	  Private _lblCapsCount As System.Windows.Forms.Label
	  Private WithEvents _btnOk As System.Windows.Forms.Button
	  Private _lstCaps As System.Windows.Forms.ListBox
	  ''' <summary>
	  ...
	  Private Sub InitializeComponent()
		 ...
		 ' _btnOk
		 ' 
		 Me._btnOk.Location = New System.Drawing.Point(119, 280)
...
'		 Me.Load += New System.EventHandler(Me.SupportedCaps_Load);
		 Me._gbCaps.ResumeLayout(False)
		 Me.ResumeLayout(False)

	  End Sub
	  #End Region
	  Public _caps As TwainCapabilityType() = Nothing

	  Private Sub SupportedCaps_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
		 Dim availableCapsCount As Integer = _caps.Length
		 Dim i As Integer = 0
		 Do While i < _caps.Length
			Select Case _caps(i)
