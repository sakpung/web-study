...
Namespace PrintToPACSDemo
   Public Partial Class SupportedCapabilitiesForm : Inherits Form
	  Public Sub New()
		 InitializeComponent()
	  End Sub
   ...
   Private Sub _wiaSession_EnumCapabilitiesEvent(ByVal sender As Object, ByVal e As Global.Leadtools.Wia.WiaEnumCapabilitiesEventArgs)
   ...
   End Sub
	  ...
	  Private Sub ShowCapabilityValidValues(ByVal itemIndex As Integer)
		 Dim capability As WiaCapability = CType(FrmMain._capabilitiesList(itemIndex), WiaCapability)
		 If ((capability.PropertyAttributes And WiaPropertyAttributesFlags.List) = WiaPropertyAttributesFlags.List) OrElse ((capability.PropertyAttributes And WiaPropertyAttributesFlags.Flag) = WiaPropertyAttributesFlags.Flag) Then
			...
			End Using
		 Else If (capability.PropertyAttributes And WiaPropertyAttributesFlags.Range) = WiaPropertyAttributesFlags.Range Then
