...
Namespace PrintToPACSDemo
   Public Partial Class AcquireOptionsForm
	  ''' <summary>
...
'		 Me._rdFileMode.Click += New System.EventHandler(Me._rdFileMode_Click);
		 ...
		 ' _gbFileModeOptions
		 ' 
		 Me._gbFileModeOptions.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles))
...
'		 Me._cbAppendToFile.Click += New System.EventHandler(Me._cbAppendToFile_Click);
		 ' 
...
'		 Me._cbOverwriteExisting.Click += New System.EventHandler(Me._cbOverwriteExisting_Click);
		 ' 
		 ' _cbSaveToOneFile
		 ' 
...
'		 Me._tbFileName.TextChanged += New System.EventHandler(Me._tbFileName_TextChanged);
		 ' 
		 ' _lblFileName
		 ' 
		 ...
		 ' 
		 Me._gbTransferBufferOptions.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
		 ...
		 Me._numMemoryBufferSize.TabIndex = 9
'		 Me._numMemoryBufferSize.Leave += New System.EventHandler(Me._numMemoryBufferSize_Leave);
		 ' 
...
'		 Me.Load += New System.EventHandler(Me.AcquireOptionsForm_Load);
