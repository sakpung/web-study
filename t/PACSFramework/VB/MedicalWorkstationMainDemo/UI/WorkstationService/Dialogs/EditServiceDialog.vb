   ...
   Partial Public Class EditServiceDialog
	  ...
	  End Property
        ...
        Public Sub New(ByVal settings As ServerSettings)
            ...
            AddHandler ServerSecureCheckBox.CheckedChanged, AddressOf ServerSecureCheckBox_CheckedChanged

            settings = settings
        End Sub

        Private Sub ServerSecureCheckBox_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs)
            If ServerSecureCheckBox.Checked Then
