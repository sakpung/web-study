...
Namespace DicomDemo
   Public Partial Class HelpDialog : Inherits Form
	  ...
	  Private Sub _HelpDialog_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
		 ...
		 _richTextBoxHelp.SelectionColor = Color.Black
		 BoldText("This demo shows how to use the high level Leadtools.Dicom.Scu component to query a DICOM server for Modality Worklist.  In addition it shows how to use the high level components to manage a Modality Performed Procedure Step." & Constants.vbLf + Constants.vbLf + Constants.vbLf)
		 ...
		 _richTextBoxHelp.SelectedText = "Click the "
		 BoldText("Search")
		 _richTextBoxHelp.SelectedText = " button to display the worklist items found." & Constants.vbLf + Constants.vbLf

		 _richTextBoxHelp.SelectedText = "Select a "
		 BoldText("Worklist Items Found")
		 _richTextBoxHelp.SelectedText = " item to create a modality performed procedure step." & Constants.vbLf + Constants.vbLf

		 _richTextBoxHelp.SelectedText = "Double-click a "
		 BoldText("Worklist Items Found")
		 _richTextBoxHelp.SelectedText = " item to display the original worklist DICOM dataset received."
