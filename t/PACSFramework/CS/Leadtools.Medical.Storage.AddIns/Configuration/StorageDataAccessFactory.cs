...
{
   public class StorageDataAccessFactory : Leadtools.Medical.DataAccessLayer.DataAccessFactory
   {
   ...
   public class StorageCatalogFactory : Leadtools.Medical.DataAccessLayer.CatalogFactory
   {
