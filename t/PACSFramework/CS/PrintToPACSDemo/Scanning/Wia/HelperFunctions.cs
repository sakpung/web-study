...
namespace PrintToPACSDemo
{
   class HelperFunctions
   {
      ...
      public static void GetFormatFilterAndExtension()
      {
         ...
         if (FrmMain._wiaProperties.DataTransfer.Format == WiaFileFormats.None) // GetProperties() method not called yet.
         {
            format = WiaFileFormats.Bmp;
         }
         else
         {
            format = FrmMain._wiaProperties.DataTransfer.Format;
         }
