...
namespace Leadtools.Medical.HL7MWL.AddIn
{
   ...
   public class HL7Options
   {
      ...
      private bool _HandleDuplicates;
      ...
      [Category("MWL")]
      [DisplayName("MWL Handle Duplicates")]
      [Description("MWL Handle Duplicates")]
      public bool HandleDuplicates
      {
         get { return _HandleDuplicates; }
         set { _HandleDuplicates = value; }
      }
