      ...
      #region Public
         ...
         #region Methods
            ...
            public void Run ( ) 
            {
               ...
               if ( IsUninstallMode ( ) )
               {
                  dbConfigured = IsDbComponentsConfigured ( out message ) ;
      ...
      #region Private
         ...
         #region Methods
            ...
            private void RegisterServices ( )
            {
               ...
               try
               {
                  IWorkstationDataAccessAgent wsDataAccess = DataAccessFactory.GetInstance ( new WorkstationDataAccessConfigurationView ( ) ).CreateDataAccessAgent <IWorkstationDataAccessAgent> ( ) ;
               ...
               try
               {
                  IStorageDataAccessAgent storageDataAccess = DataAccessFactory.GetInstance ( new StorageDataAccessConfigurationView ( ) ).CreateDataAccessAgent <IStorageDataAccessAgent> ( ) ;
               ...
               try
               {
                  IUserManagementDataAccessAgent userManagement = DataAccessFactory.GetInstance ( new UserManagementDataAccessConfigurationView ( ) ).CreateDataAccessAgent <IUserManagementDataAccessAgent> ( ) ;
            ...
            {
               {
                  ...
                  if ( DialogResult.Yes == result ) 
                  {
                     ...
                     if ( File.Exists ( dbManagerFileName ) )
                     {
                        ...
                        bool isDbConfigured = IsDbComponentsConfigured ( out missingDbComponents ) ;
            ...
            private void SetWorkstationSettings ( )
            {
               ...
               {
                  MessageBox.Show ( "Problem occuren loading Workstation settings.\n" + exception.Message,
                                     Caption,
                                     MessageBoxButtons.OK,
                                     MessageBoxIcon.Warning ) ;
               }
            ...
            private static bool IsDbComponentsConfigured ( out string missingDbComponents )
            {
               ...
               if ( !WorkstationUtils.IsDataAccessSettingsValid ( loggingConfig.DataAccessSettingsSectionName ) )
               {
                  missingDbComponents += "DICOM Logging Database.\n\n" ;
               }
               
               if ( !WorkstationUtils.IsDataAccessSettingsValid ( storageConfig.DataAccessSettingsSectionName ) )
               {
                  missingDbComponents += "DICOM Storage Database.\n\n" ;
               }
               
               if ( !WorkstationUtils.IsDataAccessSettingsValid ( workstationConfig.DataAccessSettingsSectionName ) )
               {
                  missingDbComponents += "Workstation Database.\n\n" ;
               }
               
               if ( !WorkstationUtils.IsDataAccessSettingsValid ( userManagConfig.DataAccessSettingsSectionName ) )
               {
                  missingDbComponents += "User Management Database.\n\n" ;
               }
