               ...
               if (_ocrPage.TableZoneManager != null && zone.ZoneType == OcrZoneType.Table && cells != null && cells.Length > 0 && CellPen != null)
               {
                  ...
                  if (gState != null)
                  {
                     foreach (OcrZoneCell cell in cells)
                     {
                        ...
                        //   DrawLine(graphics, OcrCellBorder.Left, cell.LeftBorderStyle, (int)cell.LeftBorderWidth.Value, (float)rc.Left, (float)rc.Top, (float)rc.Left, (float)rc.Bottom);
                        //   DrawLine(graphics, OcrCellBorder.Top, cell.TopBorderStyle, (int)cell.TopBorderWidth.Value, (float)rc.Left, (float)rc.Top, (float)rc.Right, (float)rc.Top);
                        //   DrawLine(graphics, OcrCellBorder.Right, cell.RightBorderStyle, (int)cell.RightBorderWidth.Value, (float)rc.Right, (float)rc.Top, (float)rc.Right, (float)rc.Bottom);
                        //   DrawLine(graphics, OcrCellBorder.Bottom, cell.BottomBorderStyle, (int)cell.BottomBorderWidth.Value, (float)rc.Left, (float)rc.Bottom, (float)rc.Right, (float)rc.Bottom);
                        //}
                     }
