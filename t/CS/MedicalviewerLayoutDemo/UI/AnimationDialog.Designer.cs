namespace MedicalViewerLayoutDemo
{
   partial class AnimationDialog
   {
      ...
      private void InitializeComponent()
      {
          ...
          this._txtTo = new MedicalViewerLayoutDemo.NumericTextBox();
          this._txtFrom = new MedicalViewerLayoutDemo.NumericTextBox();
          this.label6 = new System.Windows.Forms.Label();
          this._txtFrames = new MedicalViewerLayoutDemo.NumericTextBox();
