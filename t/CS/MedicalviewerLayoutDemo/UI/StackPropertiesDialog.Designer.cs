namespace MedicalViewerLayoutDemo
{
   partial class StackPropertiesDialog
   {
      ...
      private void InitializeComponent()
      {
         ...
         this._btnActionCursor = new MedicalViewerLayoutDemo.CursorButton();
         this._chkCircular = new System.Windows.Forms.CheckBox();
         this.label2 = new System.Windows.Forms.Label();
         this.groupBox3 = new System.Windows.Forms.GroupBox();
         this._txtActiveSubCell = new MedicalViewerLayoutDemo.NumericTextBox();
         this.label9 = new System.Windows.Forms.Label();
         this._txtStack = new MedicalViewerLayoutDemo.NumericTextBox();
         ...
         this._cmbApplyToCells.Items.AddRange(new object[] {
            ...
            "All",
            "Custom"});
         this._cmbApplyToCells.Location = new System.Drawing.Point(93, 25);
         ...
         this.groupBox1.Size = new System.Drawing.Size(196, 126);
         ...
         this._btnActionCursor.Location = new System.Drawing.Point(103, 24);
         ...
         // groupBox3
         // 
         this.groupBox3.Controls.Add(this._txtActiveSubCell);
         this.groupBox3.Controls.Add(this.label9);
         this.groupBox3.Controls.Add(this._txtStack);
         this.groupBox3.Controls.Add(this.label8);
         this.groupBox3.Controls.Add(this._cmbApplyToCells);
         this.groupBox3.Controls.Add(this._txtCellIndex);
         this.groupBox3.Controls.Add(this.label7);
         this.groupBox3.Controls.Add(this.label6);
         this.groupBox3.Location = new System.Drawing.Point(213, 8);
         ...
         // _txtActiveSubCell
         // 
         this._txtActiveSubCell.Location = new System.Drawing.Point(93, 166);
         this._txtActiveSubCell.MaximumAllowed = 100;
         this._txtActiveSubCell.MinimumAllowed = 0;
         this._txtActiveSubCell.Name = "_txtActiveSubCell";
         this._txtActiveSubCell.Size = new System.Drawing.Size(41, 20);
         this._txtActiveSubCell.TabIndex = 16;
         this._txtActiveSubCell.Text = "0";
         this._txtActiveSubCell.Value = 0;
         // 
         // label9
         // 
         ...
         this.label9.Text = "Acti&ve sub-cell";
         // 
         // _txtStack
         // 
         this._txtStack.Location = new System.Drawing.Point(93, 122);
         this._txtStack.MaximumAllowed = 100;
         this._txtStack.MinimumAllowed = 0;
         this._txtStack.Name = "_txtStack";
         this._txtStack.Size = new System.Drawing.Size(41, 20);
         this._txtStack.TabIndex = 14;
         this._txtStack.Text = "0";
         this._txtStack.Value = 0;
         // 
         // _txtCellIndex
         // 
         this._txtCellIndex.Location = new System.Drawing.Point(93, 75);
         ...
         // _btnApply
         // 
         this._btnApply.Location = new System.Drawing.Point(366, 216);
         ...
         this._btnCancel.Location = new System.Drawing.Point(289, 216);
         ...
         this._btnOK.Location = new System.Drawing.Point(213, 216);
         ...
         this.Name = "StackPropertiesDialog";
      ...
      private NumericTextBox _txtStack;
      ...
      private NumericTextBox _txtActiveSubCell;
