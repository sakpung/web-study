namespace MedicalViewerLayoutDemo
{
   partial class OffsetPropertiesDialog
   {
      ...
      private void InitializeComponent()
      {
         ...
         this._btnActionCursor = new CursorButton();
         ...
         this._txtY = new MedicalViewerLayoutDemo.NumericTextBox();
         this._txtX = new MedicalViewerLayoutDemo.NumericTextBox();
