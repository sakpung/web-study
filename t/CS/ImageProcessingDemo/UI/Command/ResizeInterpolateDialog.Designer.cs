...
{
   partial class ResizeInterpolateDialog
   {
      /// <summary>
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ResizeInterpolateDialog));
         ...
         // _gbOptions
         // 
         this._gbOptions.Controls.Add(this._cmbInterpolation);
         ...
         resources.ApplyResources(this._cmbInterpolation, "_cmbInterpolation");
         ...
         this.Name = "ResizeInterpolateDialog";
         this.ShowIcon = false;
