     ...
     public CFind()
     {
      ...
      public DicomDataSet GetDS( )
      {
         ...
         switch(type)
         {
            ...
            case FindType.StudySeries:
               {
                  ds.Initialize(DicomClassType.StudyRootQuerySeries, DicomDataSetInitializeFlags.ExplicitVR | DicomDataSetInitializeFlags.LittleEndian | DicomDataSetInitializeFlags.AddMandatoryElementsOnly);
