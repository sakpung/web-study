...
namespace Leadtools.Annotations.WinForms
{
   ...
   public class ImageViewerAutomationControl : IAnnAutomationControl, IDisposable
   {
      ...
      private void Hook()
      {
         ...
         _imageViewer.EnabledChanged += _imageViewer_EnabledChanged;
         _imageViewer.GotFocus += _imageViewer_GotFocus;
         _imageViewer.LostFocus += _imageViewer_LostFocus;
      ...
      public virtual double AutomationDpiX
      {
         get
         {
            return _imageViewer != null ? _imageViewer.ScreenDpi.Width : 96;
         }
      }
      ...
      public virtual double AutomationDpiY
      {
         get
         {
            return _imageViewer != null ? _imageViewer.ScreenDpi.Height : 96;
         }
      }
      ...
      public virtual bool AutomationEnabled
      {
         get
         {
            return _imageViewer != null && _imageViewer.Enabled;
         }
      }
      ...
      private void _imageViewer_GotFocus(object sender, EventArgs e)
      {
      ...
      /*
      private AnnContainer GetCurrentContainer()
      {
         if (_automationObject != null && _containerIndex != -1)
            return _automationObject.Containers[_containerIndex];
