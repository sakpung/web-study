<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="OcrJobProcessorClientPage.aspx.cs"
   Inherits="OcrJobProcessorClientDemo.OcrJobProcessorClientPage" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
   ...
   <title>OcrJobProcessorClient Main Page</title>
                     ...
                     <ContentTemplate>
                        ...
                        <table style="width: 100%;">
                           ...
                           <tr>
                              ...
                              <td class="style9">
                                 <asp:DropDownList ID="_cmbDocumentFormats" runat="server" Width="100%" Height="20px"
                                    AutoPostBack="True">
                                    ...
                                    <asp:ListItem>Emf</asp:ListItem>
                                    <asp:ListItem>Xps</asp:ListItem>
                              ...
                              <asp:GridView ID="_gridViewClientJobs" runat="server" Height="16px" Width="810px"
                                 ...
                                 <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Output File" SortExpression="Output File">
                                       <ItemTemplate>
                                          <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#  Eval("Full Path") %>' Text='<%#  Eval("Output File") %>' Enabled='<%#  ((string)Eval("status")) == "Completed" %>' ></asp:HyperLink>
                                       </ItemTemplate>
                                    </asp:TemplateField>
