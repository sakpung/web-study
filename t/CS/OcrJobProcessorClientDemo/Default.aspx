<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OcrJobProcessorClientDemo.Default" %>
            ...
            <tr>
               ...
               <td align="left" style="border: 0; background-color: #808080;" dir="ltr" bgcolor="White"
                  ...
                  <h1 style="background-position: center; background: #808080; font-family: Arial;
                     ...
                     LEADTOOLS OCR JobProcessor Web Demo</h1>
               </td>
            </tr>
            <tr>
...
<table border="0" cellpadding="0" style="background-color: #CCCCCC">
                                    ...
                                    <tr>
                                       <td align="right" colspan="2" class="style11">
                                          <asp:Button ID="_btnEnter" runat="server" Text="Enter" PostBackUrl="~/OcrJobProcessorClientPage.aspx"
            ...
            <tr>
               <td style="background-color: #FFFFFF" class="style6" colspan="2">
                  <div style="text-align: left">
                     <p>
                        This demo uses LEADTOOLS WCF Job Processor service.
                        By default this demo will look for the WCF service on the localhost. If you have
                        hosted the service somewhere else, or have updated the alias name in the host application,
                        you need to update the URL in the "Web.Config" (see below):</p>
                     <pre style="text-align: left; background-color: #CCCCCC;" class="style7">
&lt;OcrJobProcessorClientDemo.Properties.Settings&gt;
   &lt;setting name="CSOcrJobProcessorClientDemo_JobService_JobService" serializeAs="String"&gt;
