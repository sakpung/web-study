...
namespace OcrMultiEngineDemo.ViewerControl
{
   ...
   public partial class ViewerControl : UserControl
   {
      ...
      private AnnAutomation _annAutomation = null;
      ...
      protected override void OnLoad(EventArgs e)
      {
         if (!DesignMode)
         {
            ...
            // Pad the viewer
            _rasterImageViewer.Padding = new System.Windows.Forms.Padding(10);
      ...
      void Container_ObjectRemoved(object sender, AnnObjectCollectionEventArgs e)
      {
      ...
      private LeadRect BoundsFromAnnotations(AnnRectangleObject rectObject, AnnContainer container)
      {
         ...
         LeadRect rect = new LeadRectD(rc.X, rc.Y, rc.Width, rc.Height).ToLeadRect();
         return rect;
      }
