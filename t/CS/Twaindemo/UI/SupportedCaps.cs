...
namespace TwainDemo
{
   ...
   public class SupportedCaps : System.Windows.Forms.Form
   {
      ...
      private void InitializeComponent( )
      {
         ...
         resources.ApplyResources(this._gbCaps, "_gbCaps");
         this._gbCaps.Name = "_gbCaps";
         this._gbCaps.TabStop = false;
         // 
         // _lstCaps
         // 
         resources.ApplyResources(this._lstCaps, "_lstCaps");
         this._lstCaps.Name = "_lstCaps";
         // 
         // _lblCapsCount
         // 
         resources.ApplyResources(this._lblCapsCount, "_lblCapsCount");
         this._lblCapsCount.Name = "_lblCapsCount";
         // 
         // _lblCaps
         // 
         resources.ApplyResources(this._lblCaps, "_lblCaps");
