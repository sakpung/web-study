...
'		 Me._cbUseLocation.CheckedChanged += New System.EventHandler(Me._cbUseLocation_CheckedChanged);
		 ' 
		 ' _cbUseCount
		 ' 
...
'		 Me._cbUseCount.CheckedChanged += New System.EventHandler(Me._cbUseCount_CheckedChanged);
		 ' 
		 ' _cbImageUnchanged
		 ' 
...
'		 Me._numMaxCount.Leave += New System.EventHandler(Me._num_Leave);
		 ' 
		 ' _numMinHeight
		 ' 
...
'		 Me._numMinCount.Leave += New System.EventHandler(Me._num_Leave);
		 ' 
		 ' _numMinWidth
		 ' 
...
'		 Me.Load += New System.EventHandler(Me.HolePunchRemoveDialog_Load);
