...
#Region " Windows Form Designer generated code "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Template))
...
#End Region
   ...
   Private _unitsValue As TwainImageUnit()
   Private _pixelValue As TwainCapabilityValue()
   Private _orientationValue As TwainPaperOrientation()
   Private _compressionValue As TwainCapabilityValue()
   Private _formatValue As TwainCapabilityValue()
   Public transferComp As Integer
   Public transferFormat As Integer
   ...
   Private Sub FillUnitsCap()
      ...
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageUnits, TwainGetCapabilityMode.GetValues)
         ...
         Select Case twnCap.Information.ContainerType
            Case TwainContainerType.OneValue
               ...
               Dim itemValue As TwainImageUnit = CType(item, TwainImageUnit)
   ...
   Private Sub FillFrameCaps()
      ...
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageFrames, TwainGetCapabilityMode.GetValues)
   ...
   Private Sub FillXYRes()
      ...
      ' ICAP_XRESOLUTION
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageXResolution, TwainGetCapabilityMode.GetValues)
      ...
      ' ICAP_YRESOLUTION
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageYResolution, TwainGetCapabilityMode.GetValues)
   ...
   Private Sub FillTransferMode()
      ...
      ' ICAP_XFERMECH
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageTransferMechanism, TwainGetCapabilityMode.GetValues)
   ...
   Private Sub EnableFileMode()
      transferMode = TwainTransferMode.File
   ...
   Private Sub FillImageFileFormat()
      ...
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageImageFileFormat, TwainGetCapabilityMode.GetValues)
   ...
   Private Sub FillCompression()
      ...
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageCompression, TwainGetCapabilityMode.GetValues)
   ...
   Private Sub FillPixelType()
      ...
      ' ICAP_PIXELTYPE
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImagePixelType, TwainGetCapabilityMode.GetValues)
   ...
   Private Sub FillOrientation()
      ...
      ' ICAP_ORIENTATION
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageOrientation, TwainGetCapabilityMode.GetValues)
         ...
         Select Case twnCap.Information.ContainerType
            Case TwainContainerType.OneValue
               Dim item As Object = twnCap.OneValueCapability.Value
               Dim itemValue As TwainPaperOrientation = CType(item, TwainPaperOrientation)
               Select Case itemValue
   ...
   Private Sub FillEffectsCap(ByVal capType As TwainCapabilityType)
      ...
      Try
         twnCap = twnSession.GetCapability(capType, TwainGetCapabilityMode.GetValues)
   ...
   Private Sub FillHalftones()
      ...
      ' ICAP_HALFTONES
      Try
         twnCap = twnSession.GetCapability(TwainCapabilityType.ImageHalftones, TwainGetCapabilityMode.GetValues)
   ...
   Private Function GetFileFormatString() As String
      Dim filterString As String = "All Files|*.*"
      Select Case _formatValue(_cmbFileFormat.SelectedIndex)
         Case TwainCapabilityValue.FileFormatTiff
            filterString = "TIFF Files|*.tif"
         Case TwainCapabilityValue.FileFormatPict
            filterString = "PICT Files|*.pct"
         Case TwainCapabilityValue.FileFormatBmp
            filterString = "BMP Files|*.bmp"
         Case TwainCapabilityValue.FileFormatXbm
            filterString = "XBM Files|*.xbm"
         Case TwainCapabilityValue.FileFormatJfif
            filterString = "JFIF Files|*.jpg"
         Case TwainCapabilityValue.FileFormatFpx
            filterString = "FPX Files|*.fpx"
         Case TwainCapabilityValue.FileFormatTiffMulti
            filterString = "TIFF Multi Files|*.tif"
         Case TwainCapabilityValue.FileFormatPng
            filterString = "PNG Files|*.png"
         Case TwainCapabilityValue.FileFormatSpiff
            filterString = "SPIFF Files|*.spif"
         Case TwainCapabilityValue.FileFormatExif
            filterString = "EXIF Files|*.xif"
      End Select
      GetFileFormatString = filterString
   End Function
   ...
   Private Sub _btnLoad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _btnLoad.Click
      ...
      Try
         ...
         If openDialog.ShowDialog(Me) = System.Windows.Forms.DialogResult.OK Then
            Try
               twnSession.LoadTemplateFile(openDialog.FileName)
               InitializeTemplate()
            Catch ex As Exception
   ...
   Private Sub _btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _btnSave.Click
      ...
      Try
         ...
         If saveDialog.ShowDialog(Me) = System.Windows.Forms.DialogResult.OK Then
            Try
               twnSession.SaveTemplateFile(saveDialog.FileName)
            Catch ex As Exception
               Messager.ShowError(Me, ex)
            End Try
         End If
   ...
   Private Sub SetUnitsCapability()
      Try
         twnSession.ImageUnit = _unitsValue(_cmbUnit.SelectedIndex)
      Catch ex As Exception
   ...
   Private Sub SetXYResCapability()
      Try
         ...
         twnSession.Resolution = New SizeF(xRes, yRes)

      Catch ex As Exception
         Dim errorMsg As String = String.Format("Set TwainCapabilityType.ImageXResolution Or TwainCapabilityType.ImageYResolution returns {0}", ex.Message)
         AddErrorToErrorList(errorMsg)
      End Try
   End Sub
   ...
   Private Sub SetXferCapability()
      Select Case transferMode
         ...
         Case TwainTransferMode.Buffer
            transferComp = CType(_compressionValue(_cmbCompression.SelectedIndex), Integer)
         Case TwainTransferMode.File
            If _txtFileName.Text = "" Then
               Return
            End If

            transferFile = _txtFileName.Text

            ' ICAP_IMAGEFILEFORMAT
            transferFormat = CType(_formatValue(_cmbFileFormat.SelectedIndex), Integer)
      End Select

      Try
         Dim o As TwainTransferOptions = twnSession.TransferOptions
         o.TransferMode = transferMode
         o.FileFormat = CType(transferFormat, RasterImageFormat)
         o.FileName = transferFile
         o.CompressionMode = CType(transferComp, TwainCompressionMode)
         twnSession.TransferOptions = o
      Catch ex As Exception
         Dim errorMsg As String = String.Format("SetTransferOptions returns {0}", ex.Message)
         AddErrorToErrorList(errorMsg)
      End Try
   End Sub

   Private Sub SetPixelTypeCapability()
      Dim bpp As Integer = CType(TwainCapabilityValue.PixelTypeBW, Integer)
      Select Case (_pixelValue(_cmbPixelType.SelectedIndex))
         Case TwainCapabilityValue.PixelTypeBW
            bpp = 1
         Case TwainCapabilityValue.PixelTypeGray
            bpp = 8
      ...
      Try
         ...
         twnSession.ImageBitsPerPixel = bpp
      Catch ex As Exception
   ...
   Private Sub SetContrastCapability()
      Try
         ...
         Dim ie As TwainImageEffects = twnSession.ImageEffects
         ie.Contrast = contrast
         twnSession.ImageEffects = ie
      Catch ex As Exception
   ...
   Private Sub SetHighlightCapability()
      Try
         Dim highlight As Single = CType(Convert.ToDouble(_cmbHighlight.SelectedItem), Single)
         Dim ie As TwainImageEffects = twnSession.ImageEffects
