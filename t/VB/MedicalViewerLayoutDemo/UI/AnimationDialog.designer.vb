...
Namespace MedicalViewerLayoutDemo
   Public Partial Class AnimationDialog
	  ''' <summary>
	  ...
	  Private Sub InitializeComponent()
		  ...
		  Me._txtTo = New MedicalViewerLayoutDemo.NumericTextBox()
		  Me._txtFrom = New MedicalViewerLayoutDemo.NumericTextBox()
		  Me.label6 = New System.Windows.Forms.Label()
		  Me._txtFrames = New MedicalViewerLayoutDemo.NumericTextBox()
