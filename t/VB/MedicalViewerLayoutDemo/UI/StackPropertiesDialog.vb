...
Namespace MedicalViewerLayoutDemo
   Public Partial Class StackPropertiesDialog : Inherits Form
	  ...
	  Public Sub New(ByVal owner As MainForm, ByVal selectedCell As MedicalViewerCell)
		 ...
		 Else
			 _stack = CType(MainForm.GlobalCell.GetActionProperties(MedicalViewerActionType.Stack, _txtCellIndex.Value), MedicalViewerStack)
	  ...
	  Private Sub _btnApply_Click(ByVal sender As Object, ByVal e As EventArgs) Handles _btnApply.Click
		  ...
		  MainForm.GlobalCell.SetActionKeys(MedicalViewerActionType.Stack, _keys)
		  MainForm.GlobalCell.SetActionProperties(MedicalViewerActionType.Stack, _stack)

		  For Each cell As MedicalViewerMultiCell In _Viewer.Cells
			 MainForm.CopyKeysFromGlobalCell(MainForm.GlobalCell, cell, MedicalViewerActionType.Stack)
			 MainForm.CopyActionPropertiesFromGlobalCell(MainForm.GlobalCell, cell, MedicalViewerActionType.Stack)
		  Next cell
