...
Namespace MedicalViewerLayoutDemo
   Public Partial Class AlphaPropertiesDialog : Inherits Form
	  ...
	  Public Sub New(ByVal owner As MainForm, ByVal selectedCell As MedicalViewerCell)
		 ...
		 Else
			 _alpha = CType(MainForm.GlobalCell.GetActionProperties(MedicalViewerActionType.Alpha), MedicalViewerAlpha)
			_keys = MainForm.GlobalCell.GetActionKeys(MedicalViewerActionType.Alpha)
		 End If
	  ...
	  Private Sub _btnApply_Click(ByVal sender As Object, ByVal e As EventArgs) Handles _btnApply.Click
		  ...
		  MainForm.GlobalCell.SetActionKeys(MedicalViewerActionType.Alpha, _keys)
		  MainForm.GlobalCell.SetActionProperties(MedicalViewerActionType.Alpha, _alpha)

		  For Each cell As MedicalViewerMultiCell In _Viewer.Cells
			 MainForm.CopyKeysFromGlobalCell(MainForm.GlobalCell, cell, MedicalViewerActionType.Alpha)
			 MainForm.CopyActionPropertiesFromGlobalCell(MainForm.GlobalCell, cell, MedicalViewerActionType.Alpha)
		  Next cell
