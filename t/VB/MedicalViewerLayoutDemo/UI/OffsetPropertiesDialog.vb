...
Namespace MedicalViewerLayoutDemo
   Public Partial Class OffsetPropertiesDialog : Inherits Form
	  ...
	  Public Sub New(ByVal owner As MainForm, ByVal selectedCell As MedicalViewerCell)
		 ...
		 Else
			 _offset = CType(MainForm.GlobalCell.GetActionProperties(MedicalViewerActionType.Offset, _txtCellIndex.Value), MedicalViewerOffset)
