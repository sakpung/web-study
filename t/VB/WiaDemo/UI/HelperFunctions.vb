...
Friend Class HelperFunctions
   ...
   Public Shared ReadOnly _wiaFormatsInfo() As WiaSupportedFormatsInfo = { _
      New WiaSupportedFormatsInfo(WiaFileFormats.MemoryBmp, "", ""), _
      New WiaSupportedFormatsInfo(WiaFileFormats.MemoryBmp, "", ""), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Bmp, "BMP Files|*.bmp", "bmp"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Ciff, "CIFF Files|*.iff", "iff"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Emf, "EMF Files|*.emf", "emf"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Exif, "EXIF Files|*.tif", "tif"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Fpx, "FPX Files|*.fpx", "fpx"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Gif, "GIF Files|*.gif", "gif"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Ico, "ICO Files|*.ico", "ico"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Jbig, "JBIG Files|*.jbg", "jbg"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Jpeg, "JPEG Files|*.jpg", "jpg"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.J2k, "JPEG2K Files|*.j2k", "j2k"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.J2kx, "JPEG2KX Files|*.j2k", "j2k"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Pcd, "PCD Files|*.pcd", "pcd"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Pct, "PCT Files|*.pct", "pct"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Png, "PNG Files|*.png", "png"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Raw, "RAW Files|*.raw", "raw"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.RawRgb, "RAWRGB Files|*.raw", "raw"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Tiff, "TIFF Files|*.tif", "tif"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Wmf, "WMF Files|*.wmf", "wmf"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Rtf, "RTF Files|*.rtf", "rtf"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Xml, "XML Files|*.xml", "xml"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Html, "HTML Files|*.htm", "htm"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Txt, "TXT Files|*.txt", "txt"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Pdfa, "PDFA Files|*.pdf", "pdf"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Xps, "XPS Files|*.xps", "xps"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Mpg, "MPEG Files|*.mpg", "mpg"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Avi, "AVI Files|*.avi", "avi"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Wav, "WAV Files|*.wav", "wav"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Mp3, "MP3 Files|*.mp3", "mp3"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Aiff, "AIFF Files|*.iff", "iff"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Wma, "WMA Files|*.wma", "wma"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Asf, "ASF Files|*.asf", "asf"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Script, "SCRIPT Files|*.ps", "ps"), _
      New WiaSupportedFormatsInfo(WiaFileFormats.Exec, "EXEC Files|*.exe", "exe"), _
   ...
   Public Shared ReadOnly _wiaPropertyValuesInfo() As WiaPropertyValuesInfo = { _
      New WiaPropertyValuesInfo(WiaPropertyId.CameraDeviceExposureMode, WiaPropertyValues.CameraDeviceExposureModes), _
      New WiaPropertyValuesInfo(WiaPropertyId.CameraDeviceFlashMode, WiaPropertyValues.CameraDeviceFlashModes), _
      New WiaPropertyValuesInfo(WiaPropertyId.CameraDeviceFocusMode, WiaPropertyValues.CameraDeviceFocusModes), _
      New WiaPropertyValuesInfo(WiaPropertyId.CameraDeviceEffectMode, WiaPropertyValues.CameraDeviceEffectMode), _
      New WiaPropertyValuesInfo(WiaPropertyId.CameraDeviceCaptureMode, WiaPropertyValues.CameraDeviceCaptureMode), _
      New WiaPropertyValuesInfo(WiaPropertyId.CameraDeviceExposureMeteringMode, WiaPropertyValues.CameraDeviceExposureMeteringMode), _
      New WiaPropertyValuesInfo(WiaPropertyId.CameraDeviceWhiteBalance, WiaPropertyValues.CameraDeviceWhiteBalance), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerDeviceDocumentHandlingSelect, WiaPropertyValues.ScannerDeviceDocumentHandlingSelect), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerDeviceDocumentHandlingCapabilities, WiaPropertyValues.ScannerDeviceDocumentHandlingCapabilities), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerDeviceOrientation, WiaPropertyValues.ScannerDeviceOrientation), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerItemRotation, WiaPropertyValues.ScannerItemRotation), _
      New WiaPropertyValuesInfo(WiaPropertyId.ItemCompression, WiaPropertyValues.ItemCompression), _
      New WiaPropertyValuesInfo(WiaPropertyId.ItemDatatype, WiaPropertyValues.ItemDatatype), _
      New WiaPropertyValuesInfo(WiaPropertyId.ItemPlanar, WiaPropertyValues.ItemPlanar), _
      New WiaPropertyValuesInfo(WiaPropertyId.ItemTymed, WiaPropertyValues.ItemTymed), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerDevicePageSize, WiaPropertyValues.ScannerDevicePageSize), _
      New WiaPropertyValuesInfo(WiaPropertyId.ItemAccessRights, WiaPropertyValues.ItemAccessRights), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerDeviceDocumentHandlingStatus, WiaPropertyValues.ScannerDeviceDocumentHandlingStatus), _
      New WiaPropertyValuesInfo(WiaPropertyId.ItemFlags, WiaPropertyValues.ItemFlags), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerItemCurIntent, WiaPropertyValues.ScannerItemCurIntent), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerItemAutoDeskew, WiaPropertyValues.ScannerItemAutoDeskew), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerItemPhotometricInterp, WiaPropertyValues.ScannerItemPhotometricInterp), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerItemFilmScanMode, WiaPropertyValues.ScannerItemFilmScanMode), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerItemLamp, WiaPropertyValues.ScannerItemLamp), _
      New WiaPropertyValuesInfo(WiaPropertyId.ScannerDevicePreview, WiaPropertyValues.ScannerDevicePreview), _
   ...
   Public Shared Sub GetFormatFilterAndExtension()
      ...
      If MainForm._wiaProperties.DataTransfer.Format = WiaFileFormats.None Then ' GetProperties() method not called yet.
         format_Renamed = WiaFileFormats.Bmp
      Else
         format_Renamed = MainForm._wiaProperties.DataTransfer.Format
      End If
