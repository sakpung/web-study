...
Namespace ImageProcessingDemo
   ...
   Partial Public Class MedianDialog : Inherits Form
      Private _MedianCommand As MedianCommand = Nothing
      ...
      Public Property Mediancommand() As MedianCommand
         Get
            'Update command values
            UpdateCommand()
            Return _MedianCommand
         End Get
         Set(ByVal value As MedianCommand)
