...
Partial Public Class WindowLevelDialog
   ...
   Public Sub New(level As Integer, width As Integer, minWidth As Integer, maxWidth As Integer, minLevel As Integer, maxLevel As Integer, _
    cellIndex As Integer)
      ...
      Me.Text = "WindowLevelDialog Cell: " & (cellIndex + 1)
   End Sub
