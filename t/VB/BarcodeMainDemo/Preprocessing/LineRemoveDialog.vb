...
Partial Public Class LineRemoveDialog : Inherits Form
   ...
   Public Sub New(ByVal lineRemoveCommand_Renamed As LineRemoveCommand, ByVal XResolution As Integer, ByVal YResolution As Integer)
      InitializeComponent()
      _LineRemoveCommand = lineRemoveCommand_Renamed
   ...
   Public Property LineRemoveCommand() As LineRemoveCommand
      ...
      End Get
      Set(value As LineRemoveCommand)
   ...
   Private Sub UpdateCommand()
      ...
      If _cbUseDPI.Checked Then
         If _cbMaximumGap.Checked Then
            If _cbRemoveEntireLine.Checked Then
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.None)
               End If
            Else
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None)
               End If
            End If
         Else
            If _cbRemoveEntireLine.Checked Then
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.None)
               End If
            Else
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.UseDpi) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None)
               End If
            End If
         End If
      Else
         If _cbMaximumGap.Checked Then
            If _cbRemoveEntireLine.Checked Then
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.None)
               End If
            Else
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseGap) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None)
               End If
            End If
         Else
            If _cbRemoveEntireLine.Checked Then
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.RemoveEntire) Or (LineRemoveCommandFlags.None)
               End If
            Else
               If _cbLineVariance.Checked Then
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.UseVariance)
               Else
                  _LineRemoveCommand.Flags = (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None) Or (LineRemoveCommandFlags.None)
               End If
            End If
         End If
      End If
