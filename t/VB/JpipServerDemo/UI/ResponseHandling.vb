...
Imports System.Windows.Forms
   ...
   Partial Public Class ResponseHandling : Inherits Form
      ...
      Private Sub Requests_Handling_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Click
      ...
      Public Property DataFolder() As String
         Get
            Return txtDumpdataFolder.Text
         End Get

         Set(ByVal value As String)
            txtDumpdataFolder.Text = Value
         End Set
      End Property
      ...
      Private Sub btnBrowse_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnBrowse.Click
         If folderBrowserDialog1.ShowDialog() = DialogResult.OK Then
            txtDumpdataFolder.Text = folderBrowserDialog1.SelectedPath
         End If
      End Sub
   End Class
