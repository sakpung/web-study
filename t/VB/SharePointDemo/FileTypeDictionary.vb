...
Namespace SharePointDemo
   ...
   Friend Class FileTypeDictionary
      ...
      Private Shared Function SHGetFileInfo(ByVal pszPath As String, ByVal dwFileAttributes As Integer, ByRef psfi As SHFILEINFO, ByVal cbFileInfo As Integer, ByVal uFlags As SHGFI) As IntPtr
      End Function
      ...
      Public Sub Add(ByVal extension As String)
         ...
         Dim ret As IntPtr = SHGetFileInfo(dummyFileName, 0, shinfo, Marshal.SizeOf(shinfo), flags)
