...
Namespace OcrDemo
   Partial Public Class SaveDocumentDialog
      ...
      Private _customFileName As Boolean = False ' Has user given own file name.
      ...
      Public Sub New(ocrDocument As IOcrDocument, initialFormat As DocumentFormat, initialFileName As String, viewDocument As Boolean, customFileName As Boolean)
         InitializeComponent()
      ...
      Public Property CustomFileName() As Boolean
         Get
      ...
      Private Sub _browseButton_Click(sender As Object, e As EventArgs) Handles _browseButton.Click
      ...
      Private Sub _formatComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles _formatComboBox.SelectedIndexChanged
         ...
         If Not String.IsNullOrEmpty(fileName) Then
            Dim extension As String = GetFileExtension(mf.Format)
            If fileName.Equals(_srcFileName) AndAlso Not _customFileName Then
      ...
      Private Sub _userFormatNameComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles _userFormatNameComboBox.SelectedIndexChanged
         ' Update the extension of the file name
         ' Update the current format options tab page
         Dim fileName As String = _fileNameTextBox.Text
         If Not String.IsNullOrEmpty(fileName) Then
            ...
            If fileName.Equals(_srcFileName) AndAlso _customFileName Then
               _fileNameTextBox.Text += Convert.ToString(".") & extension
            Else
               _fileNameTextBox.Text = Path.ChangeExtension(fileName, extension)
            End If
         End If
