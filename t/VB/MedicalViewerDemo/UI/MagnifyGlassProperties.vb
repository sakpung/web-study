...
Namespace MedicalViewerDemo
   Partial Public Class MagnifyGlassProperties : Inherits Form
      ...
      Public Sub New(ByVal owner As MainForm, ByVal selectedCell As MedicalViewerCell)
         ...
         Else
            _magnifyGlass = CType(MainForm.DefaultCell.GetActionProperties(MedicalViewerActionType.MagnifyGlass), MedicalViewerMagnifyGlass)
         End If
