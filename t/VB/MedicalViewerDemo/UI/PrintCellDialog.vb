...
Namespace MedicalViewerDemo
   Partial Public Class PrintCellDialog : Inherits Form
      ...
      Private Sub UpdateCellImage(ByVal owner As MainForm)
         ...
         image = (CType(owner.Viewer.Cells(index), MedicalViewerMultiCell)).GetCellImage(subCellIndex, exploded, features)
      ...
      Public Sub New(ByVal owner As MainForm)
         ...
         index = owner.SearchForFirstSelected()
         image = Nothing
         subCellIndex = 0
         exploded = False
         SuspendLayout()
         ...
         _txtIndex.MaximumAllowed = (CType(owner.Viewer.Cells(index), MedicalViewerCell)).Image.PageCount
      ...
      Private Sub _btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles _btnSave.Click
         ...
         Try
            ...
            Try
               ...
               Finally
                  CType(rasterImage, IDisposable).Dispose()
               End Try
            Finally
