...
Namespace MainDemo
   Partial Public Class UnsharpMaskDialog : Inherits Form
      ...
      Private Sub _btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles _btnOk.Click
         ...
         ColorSpace = CType(Leadtools.Demos.Constants.GetValueFromName(GetType(UnsharpMaskCommandColorType), CStr(_cbColorSpace.SelectedItem), _initialColorSpace), UnsharpMaskCommandColorType)
