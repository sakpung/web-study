...
Namespace DicomDemo
   ...
   Public Class NewDatasetDlg : Inherits System.Windows.Forms.Form
      ...
      Friend WithEvents checkBoxAddMandatoryElementsOnly As System.Windows.Forms.CheckBox
      Friend WithEvents checkBoxAddMandatoryModulesOnly As System.Windows.Forms.CheckBox
      ...
      Public ReadOnly Property InitializeFlags() As DicomDataSetInitializeFlags
         Get
            Dim flags As DicomDataSetInitializeFlags = DicomDataSetInitializeFlags.None
            If radioButtonLE.Checked Then
               flags = flags Or DicomDataSetInitializeFlags.LittleEndian
            ElseIf radioButtonBE.Checked Then
               flags = flags Or DicomDataSetInitializeFlags.BigEndian
            End If

            If radioButtonExplicit.Checked Then
               flags = flags Or DicomDataSetInitializeFlags.ExplicitVR
            ElseIf Implicit.Checked Then
               flags = flags Or DicomDataSetInitializeFlags.ImplicitVR
            End If

            If checkBoxAddMandatoryElementsOnly.Checked Then
               flags = flags Or DicomDataSetInitializeFlags.AddMandatoryElementsOnly
            End If

            If checkBoxAddMandatoryModulesOnly.Checked Then
               flags = flags Or DicomDataSetInitializeFlags.AddMandatoryModulesOnly
            End If
            Return flags
         End Get
      End Property
...
#Region "Windows Form Designer generated code"
      ...
      Private Sub InitializeComponent()
         ...
         Me.checkBoxAddMandatoryModulesOnly.Name = "checkBoxAddMandaryModulesOnly"
